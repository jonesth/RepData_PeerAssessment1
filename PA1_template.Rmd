...
## Theory here is to replace the NA's by the mean of the corresponding interval.
...
# Reformat and expand our amended data frame to identify a weekday (WDay) and 
# weekend (WEnd)
Activity2[,2] <- as.Date(Activity2[,2])
Activity2$WDay <- weekdays(Activity2[,2])
Activity2$WdayGroup <- "week"

# Filling in the WeekDayGroup 
for (i in 1:l) {
